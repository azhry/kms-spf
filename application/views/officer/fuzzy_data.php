            ...
            <div class="col-lg-12">
                <section class="panel">
                    <header class="panel-heading">
                        <h3>
                        Daftar Fuzzy
                        <a href="<?= base_url('officer/tambah-data-fuzzy') ?>" class="btn btn-success btn-sm">
                    ...
                    <table class="table table-striped table-advance table-hover">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a class="btn btn-primary" href="<?= base_url('officer/edit-data-fuzzy/'.$row->id_fuzzy) ?>"><i class="fa fa-pencil-square-o"></i></a>
...
<script type="text/javascript">
  ...
  function delete_row(id) {
    $.ajax({
        url: '<?= base_url('officer/data-fuzzy') ?>',
        type: 'POST',
        data: {
            delete: true,
            id: id
        ...
        success: function(response) {
            ...
            window.location = '<?= base_url('officer/data-fuzzy') ?>';
        },
        error: function(e) {
