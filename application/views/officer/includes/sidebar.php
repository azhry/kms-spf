...
<aside>
    <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="<?= base_url('officer/data-penilaian') ?>" class="active"><i class="fa fa-book"></i> <span>Data Penilaian</span></a></li>
            ...
            <li><a href="<?= base_url( 'officer/data-jabatan' ) ?>" class="active"><i class="fa fa-book"></i> Data Jabatan</a></li>
            <li><a href="<?= base_url( 'officer/data-fuzzy' ) ?>" class="active"><i class="fa fa-pencil-square-o"></i> Data Fuzzy</a></li>
        </ul>
        <!-- sidebar menu end-->
    </div>
</aside>
