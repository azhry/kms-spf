...
<section id="main-content">
    <section class="wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header"><i class="fa fa-file-text-o"></i> Tambah Data Kriteria</h3>
                <ol class="breadcrumb">
                    <li><i class="fa fa-home"></i><a href="<?= base_url('officer') ?>">Dashboard</a></li>
                    <li><i class="fa fa-list-alt"></i><a href="<?= base_url('officer/data-kriteria') ?>">Data Kriteria</a></li>
            ...
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <?= form_open('officer/tambah-data-kriteria', ['id' => 'form']) ?>
                        <div class="row">
