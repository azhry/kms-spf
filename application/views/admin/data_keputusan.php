            ...
            <div class="col-lg-12">
                ...
                <section class="panel">
                    <div class="panel-heading">
                        <a href="<?= base_url( 'admin/input-keputusan' ) ?>" class="btn btn-success"><i class="fa fa-plus"></i></a>
                        <br><br>
                    </div>
                        ...
                        <table class="table table-striped table-advance table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $row->nmax ?></td>
                                    <td>
                                        <?= form_open( 'admin/data-keputusan' ) ?>
                                        <div class="btn-group">
                                            <a class="btn btn-primary" href="<?= base_url('admin/edit-keputusan/' . $row->id_keputusan) ?>"><i class="fa fa-pencil-square-o"></i></a>
